...
public class PrescriptionController {
    ...
    @GetMapping("/all")
    public ResponseEntity<ApiResponse<List<PrescriptionResponseDto>>> getAllPrescriptions(@RequestParam(required = false, value = "user_id") Integer userId) {
    ...
    @PreAuthorize("hasAnyRole({'ROLE_DOCTOR', 'ROLE_USER'})")
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<PrescriptionResponseDto>> getPrescriptionById(@RequestParam(required = false, value = "user_id") Integer userId,@PathVariable Integer id) {
    ...
    @PreAuthorize("hasRole('ROLE_DOCTOR')")
    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse<String>> deletePrescription(@RequestParam(value = "user_id") Integer userId, @PathVariable Integer id) {
    ...
    @PreAuthorize("hasRole('ROLE_DOCTOR')")
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<PrescriptionResponseDto>> updatePrescription(@PathVariable Integer id, @RequestBody CreatePrescriptionDto createPrescriptionDto) {
