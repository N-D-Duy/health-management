...
public class MedicalRecordController {
    ...
    @GetMapping("/all")
    public ResponseEntity<ApiResponse<List<MedicalRecordResponseDto>>> getAllMedicalRecords(@RequestParam(value = "userId", required = false) Integer userId) {
    ...
    @PreAuthorize("hasAnyRole({'ROLE_USER', 'ROLE_DOCTOR'})")
    @GetMapping()
    public ResponseEntity<ApiResponse<MedicalRecordResponseDto>> getMedicalRecordById(@RequestParam(value = "appointmentId") Integer appointmentId) {
    ...
    public ResponseEntity<ApiResponse<String>> deleteMedicalRecord(@PathVariable(value = "appointmentId") Integer appointmentId) {
